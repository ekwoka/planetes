...
pub trait Validable:
    Send + Sync + Default + PartialEq + Clone + ToString + Unpin + 'static
{
...
impl_validable_for_unsigned_numeric!(u8, u16, u32, u64, u128, usize);
impl_validable_for_integer_numeric!(i8, i16, i32, i64, i128, isize);
